...
ALTER database DBTEST1 collate Chinese_PRC_Stroke_CI_AI_KS_WS
...
(
	name = 'DBTEST',
	filename = '/Users/zhoutianyu/Study/SQLServer/Example/DBTEST.mdf',
	size = 5MB,
	filegrowth = 2MB
)
log on
(
	name = 'DBTEST_log',
	filename = '/Users/zhoutianyu/Study/SQLServer/Example/DBTEST_log.ldf',
	size = 5MB,
	filegrowth = 2MB
)
